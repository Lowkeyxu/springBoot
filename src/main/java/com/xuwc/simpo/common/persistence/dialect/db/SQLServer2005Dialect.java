 ...
 */
package com.xuwc.simpo.common.persistence.dialect.db;

import com.xuwc.simpo.common.persistence.dialect.Dialect;
...
public class SQLServer2005Dialect implements Dialect {
     ...
     * __row_number__, * from table_name) SELECT * FROM query WHERE __row_number__ BETWEEN :offset
    ...
    private String getLimitString(String querySqlString, int offset, int limit,
        ...
        result.append("WITH query AS (SELECT ").append(distinctStr).append("TOP 100 PERCENT ")
                        ...
                        .append(") as __row_number__, ").append(pagingBuilder)
