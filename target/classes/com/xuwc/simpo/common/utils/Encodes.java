...
public class Encodes {
    ...
    public static String encodeBase64(String input) {
        try {
            return new String(Base64.encodeBase64(input.getBytes(DEFAULT_URL_ENCODING)), StandardCharsets.UTF_8);
    ...
    public static String decodeBase64String(String input) {
        try {
            return new String(Base64.decodeBase64(input.getBytes(StandardCharsets.UTF_8)), DEFAULT_URL_ENCODING);
        } catch (UnsupportedEncodingException e) {
            return "";
        }
    }
