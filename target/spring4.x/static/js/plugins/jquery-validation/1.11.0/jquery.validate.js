...
jQuery.validator.addMethod("myDigits", function(value, element, param) {
	var d = new RegExp("^(?:[1-9]\\d*|0)(?:\\.\\d{1," + param + "})?$");
	return this.optional(element) || d.test(value)
}, "请输入正数且小数位数不大于{0}位");
jQuery.validator.addMethod("myNegativeDigits", function(value, element, param) {
	var d = new RegExp("^(-)?(?:[1-9]\\d*|0)(?:\\.\\d{1," + param + "})?$");
	return this.optional(element) || d.test(value)
}, "小数位数不大于{0}位");
...
jQuery.validator.addMethod("numOrAbc",function(value, element) {
