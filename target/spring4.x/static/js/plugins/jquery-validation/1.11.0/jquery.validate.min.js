...
(function(a) {
    ...
    a.extend(a.validator, {
        ...
        messages: {
            ...
            isPrice: "Please enter only isPrice.",
        ...
        methods: {
            ...
            digits: function(c, b) {
                return this.optional(b) || /^[1-9][0-9]*$/.test(c)
            },
            isPrice: function(c, b) {
                return this.optional(b) || /^(([0-9]|[1-9][0-9]+)\.[0-9]{1,2}|[1-9][0-9]*)$/.test(c)
            },
...
"传真格式如：0371-68787027");
jQuery.validator.addMethod("myDigits",
function(c, b, a) {
    var d = new RegExp("^(?:[1-9]\\d*|0)(?:\\.\\d{1," + a + "})?$");
    return this.optional(b) || d.test(c)
},
"请输入正数且小数位数不大于{0}位");
jQuery.validator.addMethod("myNegativeDigits",
function(c, b, a) {
    var d = new RegExp("^(-)?(?:[1-9]\\d*|0)(?:\\.\\d{1," + a + "})?$");
    return this.optional(b) || d.test(c)
},
...
"请输入字母数字或下划线");
jQuery.validator.addMethod("numOrAbc",
function(b, a) {
    return this.optional(a) || /^[a-zA-Z0-9]*$/.test(b)
},
"请输入字母或数字");

jQuery.validator.addMethod("numOrHz",
		function(b, a) {
	 		return this.optional(a) || /^[a-zA-Z]*$/.test(b) || /^[\u4e00-\u9fa5]+$/.test(b)
		},
"请输入字母或汉字");

jQuery.validator.addMethod("ename",
	function(b, a) {
...
function(c, b) {
    var a = /(^(\d{3,4}-{0,1})?\d{7,9}$)|(^1[3,4,5,7,8]\d{9}$)/g;
    return this.optional(b) || (a.test(c))
},
...
//联系方式验证
jQuery.validator.addMethod("isContactMethod", 
function (value, element) {
	var tel = /^(((0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$)|^((\d{7,9})|(\d{4}|\d{3})-(\d{7,9})|(\d{4}|\d{3})-(\d{7,9})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,9})-(\d{4}|\d{3}|\d{2}|\d{1}))$)$/;
